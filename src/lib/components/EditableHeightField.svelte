...
<div class="flex items-center justify-between py-3">
	...
	<!-- Always render imperial inputs, toggle visibility with CSS -->
	<div
		bind:this={editContainer}
		class="flex items-center gap-1"
		class:hidden={!editing || unitSystem !== 'imperial'}
	>
		<input
			bind:this={feetInput}
			bind:value={feet}
	...
	<!-- Always render metric input, toggle visibility with CSS -->
	<div class="flex items-center gap-1" class:hidden={!editing || unitSystem !== 'metric'}>
		<input
			bind:this={cmInput}
			bind:value={cm}
			type="number"
