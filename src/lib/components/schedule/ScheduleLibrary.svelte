...
<div class="px-4 pb-4">
	...
	{:else if $scheduleLibrary.length === 0}
		...
		<div class="flex flex-col items-center justify-center py-12 text-center">
			...
			<h3 class="text-lg font-medium text-slate-400 mb-2">No Schedules Yet</h3>
						...
						<div class="flex gap-1">
							{#if !schedule.scheduleMetadata.isActive}
								<button
									...
									class="p-1.5 text-slate-400 hover:text-yellow-400 transition-colors"
									title="Set as active"
								>
							...
							<button
								...
								class="p-1.5 text-slate-400 hover:text-indigo-400 transition-colors"
								title="Duplicate"
							>
								<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
									<path
